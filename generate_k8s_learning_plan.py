...
daily_tasks = {
    1: ["Understand Kubernetes architecture: Master, Nodes, API Server, etcd, Scheduler, Kubelet, Kube-proxy.", 
    ...
    2: ["Learn `kubectl` basics: create, get, describe, delete.", 
    ...
    3: ["Learn the purpose of Deployments & ReplicaSets.", 
        "Create a Deployment for Nginx.", 
        "Scale up/down Pods using Deployment: `kubectl scale deployment nginx --replicas=3`"],
    4: ["Learn about Namespaces and how to isolate workloads.", 
